...
### T48: [READY] Release candidate: pip-installable vLLM plugin
...
### T51: [READY] Benchmark 120B: ggml Vulkan vs llama.cpp Vulkan vs MLX (45-60 TPS)
...
### T56: [READY] Implement GGUF weight loader in C (parse header, map weights to VkBuffer)
